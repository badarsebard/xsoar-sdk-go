...
func (v NullableCommentsFields) Get() *CommentsFields {
	return v.value
}

func (v *NullableCommentsFields) Set(val *CommentsFields) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCommentsFields(val *CommentsFields) *NullableCommentsFields {
	return &NullableCommentsFields{value: val, isSet: true}
}
