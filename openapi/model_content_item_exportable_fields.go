...
func NewContentItemExportableFields() *ContentItemExportableFields {
	this := ContentItemExportableFields{}
	return &this
}
...
type NullableContentItemExportableFields struct {
	value *ContentItemExportableFields
	isSet bool
}

func (v NullableContentItemExportableFields) Get() *ContentItemExportableFields {
	return v.value
}

func (v *NullableContentItemExportableFields) Set(val *ContentItemExportableFields) {
	v.value = val
	v.isSet = true
}

func (v NullableContentItemExportableFields) IsSet() bool {
	return v.isSet
}

func (v *NullableContentItemExportableFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentItemExportableFields(val *ContentItemExportableFields) *NullableContentItemExportableFields {
	return &NullableContentItemExportableFields{value: val, isSet: true}
}
