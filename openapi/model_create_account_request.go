...
func (o *CreateAccountRequest) GetSyncOnCreation() bool {
	if o == nil || o.SyncOnCreation == nil {
		var ret bool
		return ret
	}
	return *o.SyncOnCreation
}

// GetSyncOnCreationOk returns a tuple with the SyncOnCreation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateAccountRequest) GetSyncOnCreationOk() (*bool, bool) {
	if o == nil || o.SyncOnCreation == nil {
		return nil, false
	}
	return o.SyncOnCreation, true
}
...
func (o CreateAccountRequest) MarshalJSON() ([]byte, error) {
	...
	if o.AccountRoles != nil {
		toSerialize["accountRoles"] = o.AccountRoles
	}
	...
	if o.SyncOnCreation != nil {
		toSerialize["syncOnCreation"] = o.SyncOnCreation
	}
