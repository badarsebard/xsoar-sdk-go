...
type NullableCreateUpdateHAGroup struct {
	value *CreateUpdateHAGroup
	isSet bool
}

func (v NullableCreateUpdateHAGroup) Get() *CreateUpdateHAGroup {
	return v.value
}

func (v *NullableCreateUpdateHAGroup) Set(val *CreateUpdateHAGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateUpdateHAGroup) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreateUpdateHAGroup(val *CreateUpdateHAGroup) *NullableCreateUpdateHAGroup {
	return &NullableCreateUpdateHAGroup{value: val, isSet: true}
}
