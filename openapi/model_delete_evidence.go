...
func (v NullableDeleteEvidence) Get() *DeleteEvidence {
	return v.value
}

func (v *NullableDeleteEvidence) Set(val *DeleteEvidence) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDeleteEvidence(val *DeleteEvidence) *NullableDeleteEvidence {
	return &NullableDeleteEvidence{value: val, isSet: true}
}
