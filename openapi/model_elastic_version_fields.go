...
type NullableElasticVersionFields struct {
	value *ElasticVersionFields
	isSet bool
}

func (v NullableElasticVersionFields) Get() *ElasticVersionFields {
	return v.value
}

func (v *NullableElasticVersionFields) Set(val *ElasticVersionFields) {
	v.value = val
	v.isSet = true
}

func (v NullableElasticVersionFields) IsSet() bool {
	return v.isSet
}
...
func NewNullableElasticVersionFields(val *ElasticVersionFields) *NullableElasticVersionFields {
	return &NullableElasticVersionFields{value: val, isSet: true}
}
