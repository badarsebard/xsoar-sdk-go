...
func (o *EvidencesFilterWrapper) GetFilter() GenericStringDateFilter {
	if o == nil || o.Filter == nil {
		var ret GenericStringDateFilter
		return ret
	}
	return *o.Filter
}
...
type NullableEvidencesFilterWrapper struct {
	value *EvidencesFilterWrapper
	isSet bool
}

func (v NullableEvidencesFilterWrapper) Get() *EvidencesFilterWrapper {
	return v.value
}

func (v *NullableEvidencesFilterWrapper) Set(val *EvidencesFilterWrapper) {
	v.value = val
	v.isSet = true
}

func (v NullableEvidencesFilterWrapper) IsSet() bool {
	return v.isSet
}
...
func NewNullableEvidencesFilterWrapper(val *EvidencesFilterWrapper) *NullableEvidencesFilterWrapper {
	return &NullableEvidencesFilterWrapper{value: val, isSet: true}
}
