...
type NullableExpirationIndicator struct {
	value *ExpirationIndicator
	isSet bool
}

func (v NullableExpirationIndicator) Get() *ExpirationIndicator {
	return v.value
}

func (v *NullableExpirationIndicator) Set(val *ExpirationIndicator) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationIndicator) IsSet() bool {
	return v.isSet
}
...
func NewNullableExpirationIndicator(val *ExpirationIndicator) *NullableExpirationIndicator {
	return &NullableExpirationIndicator{value: val, isSet: true}
}
