...
type NullableFieldTermLocationMap struct {
	value *FieldTermLocationMap
	isSet bool
}

func (v NullableFieldTermLocationMap) Get() *FieldTermLocationMap {
	return v.value
}

func (v *NullableFieldTermLocationMap) Set(val *FieldTermLocationMap) {
	v.value = val
	v.isSet = true
}

func (v NullableFieldTermLocationMap) IsSet() bool {
	return v.isSet
}
...
func NewNullableFieldTermLocationMap(val *FieldTermLocationMap) *NullableFieldTermLocationMap {
	return &NullableFieldTermLocationMap{value: val, isSet: true}
}
