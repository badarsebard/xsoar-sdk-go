...
func NewIndicatorEditBulkResponse() *IndicatorEditBulkResponse {
	this := IndicatorEditBulkResponse{}
	return &this
}
...
type NullableIndicatorEditBulkResponse struct {
	value *IndicatorEditBulkResponse
	isSet bool
}

func (v NullableIndicatorEditBulkResponse) Get() *IndicatorEditBulkResponse {
	return v.value
}

func (v *NullableIndicatorEditBulkResponse) Set(val *IndicatorEditBulkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIndicatorEditBulkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIndicatorEditBulkResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndicatorEditBulkResponse(val *IndicatorEditBulkResponse) *NullableIndicatorEditBulkResponse {
	return &NullableIndicatorEditBulkResponse{value: val, isSet: true}
}
