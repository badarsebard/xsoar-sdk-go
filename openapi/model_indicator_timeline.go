...
type NullableIndicatorTimeline struct {
	value *IndicatorTimeline
	isSet bool
}

func (v NullableIndicatorTimeline) Get() *IndicatorTimeline {
	return v.value
}

func (v *NullableIndicatorTimeline) Set(val *IndicatorTimeline) {
	v.value = val
	v.isSet = true
}
...
func NewNullableIndicatorTimeline(val *IndicatorTimeline) *NullableIndicatorTimeline {
	return &NullableIndicatorTimeline{value: val, isSet: true}
}
