...
func NewInvestigationSearchResponse() *InvestigationSearchResponse {
	this := InvestigationSearchResponse{}
	return &this
}
...
type NullableInvestigationSearchResponse struct {
	value *InvestigationSearchResponse
	isSet bool
}

func (v NullableInvestigationSearchResponse) Get() *InvestigationSearchResponse {
	return v.value
}

func (v *NullableInvestigationSearchResponse) Set(val *InvestigationSearchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInvestigationSearchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInvestigationSearchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvestigationSearchResponse(val *InvestigationSearchResponse) *NullableInvestigationSearchResponse {
	return &NullableInvestigationSearchResponse{value: val, isSet: true}
}
