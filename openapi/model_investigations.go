...
func (v NullableInvestigations) Get() *Investigations {
	return v.value
}

func (v *NullableInvestigations) Set(val *Investigations) {
	v.value = val
	v.isSet = true
}
...
func NewNullableInvestigations(val *Investigations) *NullableInvestigations {
	return &NullableInvestigations{value: val, isSet: true}
}
