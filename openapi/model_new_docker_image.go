...
// NewDockerImage NewDockerImage creation request
type NewDockerImage struct {
...
func (o NewDockerImage) MarshalJSON() ([]byte, error) {
...
type NullableNewDockerImage struct {
	value *NewDockerImage
	isSet bool
}

func (v NullableNewDockerImage) Get() *NewDockerImage {
	return v.value
}

func (v *NullableNewDockerImage) Set(val *NewDockerImage) {
	v.value = val
	v.isSet = true
}

func (v NullableNewDockerImage) IsSet() bool {
	return v.isSet
}

func (v *NullableNewDockerImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewDockerImage(val *NewDockerImage) *NullableNewDockerImage {
	return &NullableNewDockerImage{value: val, isSet: true}
}

func (v NullableNewDockerImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewDockerImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
