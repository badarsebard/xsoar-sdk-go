...
type NullablePlaybookOutputs struct {
	value *PlaybookOutputs
	isSet bool
}

func (v NullablePlaybookOutputs) Get() *PlaybookOutputs {
	return v.value
}

func (v *NullablePlaybookOutputs) Set(val *PlaybookOutputs) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePlaybookOutputs(val *PlaybookOutputs) *NullablePlaybookOutputs {
	return &NullablePlaybookOutputs{value: val, isSet: true}
}
