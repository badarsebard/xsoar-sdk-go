...
type NullablePlaybookWithWarnings struct {
	value *PlaybookWithWarnings
	isSet bool
}

func (v NullablePlaybookWithWarnings) Get() *PlaybookWithWarnings {
	return v.value
}

func (v *NullablePlaybookWithWarnings) Set(val *PlaybookWithWarnings) {
	v.value = val
	v.isSet = true
}

func (v NullablePlaybookWithWarnings) IsSet() bool {
	return v.isSet
}
...
func NewNullablePlaybookWithWarnings(val *PlaybookWithWarnings) *NullablePlaybookWithWarnings {
	return &NullablePlaybookWithWarnings{value: val, isSet: true}
}
