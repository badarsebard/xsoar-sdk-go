...
type NullableRawFeedIndicator struct {
	value *RawFeedIndicator
	isSet bool
}

func (v NullableRawFeedIndicator) Get() *RawFeedIndicator {
	return v.value
}

func (v *NullableRawFeedIndicator) Set(val *RawFeedIndicator) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRawFeedIndicator(val *RawFeedIndicator) *NullableRawFeedIndicator {
	return &NullableRawFeedIndicator{value: val, isSet: true}
}
