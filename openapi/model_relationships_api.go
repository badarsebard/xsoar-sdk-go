...
type NullableRelationshipsAPI struct {
	value *RelationshipsAPI
	isSet bool
}

func (v NullableRelationshipsAPI) Get() *RelationshipsAPI {
	return v.value
}

func (v *NullableRelationshipsAPI) Set(val *RelationshipsAPI) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRelationshipsAPI(val *RelationshipsAPI) *NullableRelationshipsAPI {
	return &NullableRelationshipsAPI{value: val, isSet: true}
}
