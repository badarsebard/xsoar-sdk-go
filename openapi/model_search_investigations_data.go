...
type NullableSearchInvestigationsData struct {
	value *SearchInvestigationsData
	isSet bool
}

func (v NullableSearchInvestigationsData) Get() *SearchInvestigationsData {
	return v.value
}

func (v *NullableSearchInvestigationsData) Set(val *SearchInvestigationsData) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchInvestigationsData) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchInvestigationsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchInvestigationsData(val *SearchInvestigationsData) *NullableSearchInvestigationsData {
	return &NullableSearchInvestigationsData{value: val, isSet: true}
}
