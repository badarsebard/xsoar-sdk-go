...
type NullableSearchStatsResponse struct {
	value *SearchStatsResponse
	isSet bool
}

func (v NullableSearchStatsResponse) Get() *SearchStatsResponse {
	return v.value
}

func (v *NullableSearchStatsResponse) Set(val *SearchStatsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchStatsResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableSearchStatsResponse(val *SearchStatsResponse) *NullableSearchStatsResponse {
	return &NullableSearchStatsResponse{value: val, isSet: true}
}
