...
func (o *SystemAgent) GetServercontext() []int32 {
	if o == nil || o.Servercontext == nil {
		var ret []int32
		return ret
	}
	return *o.Servercontext
}

// GetServercontextOk returns a tuple with the Servercontext field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemAgent) GetServercontextOk() (*[]int32, bool) {
	if o == nil || o.Servercontext == nil {
		return nil, false
	}
	return o.Servercontext, true
}
...
func (o SystemAgent) MarshalJSON() ([]byte, error) {
	...
	if o.Servercontext != nil {
		toSerialize["servercontext"] = o.Servercontext
	}
...
func (v NullableSystemAgent) Get() *SystemAgent {
	return v.value
}
...
func NewNullableSystemAgent(val *SystemAgent) *NullableSystemAgent {
	return &NullableSystemAgent{value: val, isSet: true}
}
