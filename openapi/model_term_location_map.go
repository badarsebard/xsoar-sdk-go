...
type NullableTermLocationMap struct {
	value *TermLocationMap
	isSet bool
}

func (v NullableTermLocationMap) Get() *TermLocationMap {
	return v.value
}

func (v *NullableTermLocationMap) Set(val *TermLocationMap) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTermLocationMap(val *TermLocationMap) *NullableTermLocationMap {
	return &NullableTermLocationMap{value: val, isSet: true}
}
