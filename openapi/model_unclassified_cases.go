...
type NullableUnclassifiedCases struct {
	value *UnclassifiedCases
	isSet bool
}

func (v NullableUnclassifiedCases) Get() *UnclassifiedCases {
	return v.value
}

func (v *NullableUnclassifiedCases) Set(val *UnclassifiedCases) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUnclassifiedCases(val *UnclassifiedCases) *NullableUnclassifiedCases {
	return &NullableUnclassifiedCases{value: val, isSet: true}
}
