...
func NewUpdateAccountHostResponse() *UpdateAccountHostResponse {
	this := UpdateAccountHostResponse{}
	return &this
}
...
type NullableUpdateAccountHostResponse struct {
	value *UpdateAccountHostResponse
	isSet bool
}

func (v NullableUpdateAccountHostResponse) Get() *UpdateAccountHostResponse {
	return v.value
}

func (v *NullableUpdateAccountHostResponse) Set(val *UpdateAccountHostResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAccountHostResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAccountHostResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAccountHostResponse(val *UpdateAccountHostResponse) *NullableUpdateAccountHostResponse {
	return &NullableUpdateAccountHostResponse{value: val, isSet: true}
}
