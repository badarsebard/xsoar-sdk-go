...
type NullableVersionedCommit struct {
	value *VersionedCommit
	isSet bool
}

func (v NullableVersionedCommit) Get() *VersionedCommit {
	return v.value
}

func (v *NullableVersionedCommit) Set(val *VersionedCommit) {
	v.value = val
	v.isSet = true
}
...
func NewNullableVersionedCommit(val *VersionedCommit) *NullableVersionedCommit {
	return &NullableVersionedCommit{value: val, isSet: true}
}
